...
# Training Loop for ResNet18, from https://github.com/rafael-andre1/AI-for-Interstitial-Lung-Disease-Classification
def trainResNet(train_dataset, val_dataset, num_epochs=55, batch_size=32, lr=5e-7, patience=5, improve_min=0.001):
    # New ResNet instance
